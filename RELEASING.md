...
- Re-create the CLDF dataset:
  ```shell
  cldfbench makecldf --glottolog-version v5.2 cldfbench_kolipakam_et_al2018.py --with-zenodo --with-cldfreadme
  ```
...
- Re-create the README:
  ```shell
  cldfbench readme cldfbench_kolipakam_et_al2018.py
  ```
- Run Phlorest-specific checks on the data:
  ```shell
  phlorest check --with-R cldfbench_kolipakam_et_al2018.py
  ```
...
- Create the release instruction:
  ```shell
  phlorest release cldfbench_kolipakam_et_al2018.py vX.Y
  ```
